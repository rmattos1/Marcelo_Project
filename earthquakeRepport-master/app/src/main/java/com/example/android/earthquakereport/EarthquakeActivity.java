...
public class EarthquakeActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<Earthquake>>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ListView earthquakeListView;
        earthquakeListView = findViewById(R.id.list);

        // Find the reference of the empty Id in the ayout
        ...
        // Get a reference of the ConnectivityManager to check state of connectivity
    ...
    public Loader<List<Earthquake>> onCreateLoader(int i, Bundle bundle) {
        ...
        EarthquakeLoader earthquakeLoader;
        earthquakeLoader = new EarthquakeLoader(this, USGS_REQUEST_URL);
